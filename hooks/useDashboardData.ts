...
const getPastSixMonths = (): string[] => {
    ...
    // FIX: Corrected Date constructor call. It was `new new Date()`, which is a syntax error.
...
// FIX: The explicit type `Omit<Employee, 'historicalData'>[]` was incorrect for `rawEmployees`
// because the subsequent `.map()` call adds the `historicalData` property. Removing the explicit
// type allows TypeScript to correctly infer the type as `Employee[]`, which resolves the downstream type errors.
const rawEmployees = [
  { id: 'e1', name: 'Alice Johnson', avatar: 'https://i.pravatar.cc/150?u=e1', role: 'Frontend Dev', totalHoursMonth: 160, projects: [
  ...
  { id: 'e2', name: 'Bob Williams', avatar: 'https://i.pravatar.cc/150?u=e2', role: 'Backend Dev', totalHoursMonth: 160, projects: [
  ...
  { id: 'e3', name: 'Charlie Brown', avatar: 'https://i.pravatar.cc/150?u=e3', role: 'UI/UX Designer', totalHoursMonth: 160, projects: [
  ...
  { id: 'e4', name: 'Diana Miller', avatar: 'https://i.pravatar.cc/150?u=e4', role: 'Project Manager', totalHoursMonth: 160, projects: [
  ...
  { id: 'e5', name: 'Ethan Garcia', avatar: 'https://i.pravatar.cc/150?u=e5', role: 'QA Engineer', totalHoursMonth: 160, projects: [
  ...
  { id: 'e6', name: 'Fiona Clark', avatar: 'https://i.pravatar.cc/150?u=e6', role: 'DevOps Engineer', totalHoursMonth: 160, projects: [
  ...
  { id: 'e7', name: 'George Harris', avatar: 'https://i.pravatar.cc/150?u=e7', role: 'Backend Dev', totalHoursMonth: 160, projects: [
  ...
  { id: 'e8', name: 'Hannah Lewis', avatar: 'https://i.pravatar.cc/150?u=e8', role: 'Frontend Dev', totalHoursMonth: 160, projects: [
    { projectId: 'p8', assignedHours: 100, consumedHours: 80 }, { projectId: 'p18', assignedHours: 50, consumedHours: 40 },
  ], lastWeekHours: generateLastWeekHours('normal')},
  { id: 'e9', name: 'Ian Walker', avatar: 'https://i.pravatar.cc/150?u=e9', role: 'Data Scientist', totalHoursMonth: 160, projects: [
  ...
  { id: 'e10', name: 'Jane Hall', avatar: 'https://i.pravatar.cc/150?u=e10', role: 'UI/UX Designer', totalHoursMonth: 160, projects: [
  ...
  { id: 'e11', name: 'Kevin Scott', avatar: 'https://i.pravatar.cc/150?u=e11', role: 'QA Engineer', totalHoursMonth: 160, projects: [
  ...
  { id: 'e12', name: 'Laura Green', avatar: 'https://i.pravatar.cc/150?u=e12', role: 'Frontend Dev', totalHoursMonth: 160, projects: [
  ...
  { id: 'e13', name: 'Mason Adams', avatar: 'https://i.pravatar.cc/150?u=e13', role: 'Backend Dev', totalHoursMonth: 160, projects: [
  ...
  { id: 'e14', name: 'Nora Baker', avatar: 'https://i.pravatar.cc/150?u=e14', role: 'Project Manager', totalHoursMonth: 160, projects: [
  ...
  { id: 'e15', name: 'Oscar Campbell', avatar: 'https://i.pravatar.cc/150?u=e15', role: 'DevOps Engineer', totalHoursMonth: 160, projects: [
...
const generateTasksForProject = (projectId: string): Task[] => {
    ...
    const projectTeam = rawEmployees.filter(e => e.projects.some(p => p.projectId === projectId)).map(e => e.id);
...
const rawProjects: Project[] = [
  ...
  { id: 'p28', name: 'Design System Governance', type: ProjectType.RECURRING, description: "Governing and updating the company-wide design system.", deadline: "2024-12-31T23:59:59Z", status: ProjectStatus.ON_TRACK, tasks: [], historicalData: [] },
...
export const useDashboardData = () => {
  ...
  useEffect(() => {
    const calculatedEmployees = rawEmployees.map(emp => {
    ...
    const calculatedProjects = rawProjects.map(proj => {
